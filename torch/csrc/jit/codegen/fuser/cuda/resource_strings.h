...
#if defined(USE_ROCM)
// hipRTC already provides __hip_bfloat16, __float2bfloat16, and __bfloat162float.
// Alias to __nv_bfloat16 so legacy fuser codegen (which emits CUDA-style names)
// uses HIP types without duplicate intrinsic definitions.
